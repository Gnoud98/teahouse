...
var featureBlog = function featureBlog() {
...
var section__picture = function section__picture() {
...
var menuDrink = function menuDrink() {
...
var productSame = function productSame() {
...
var asideNews = function asideNews() {
...
var productThumbnail = function productThumbnail() {
  $(document).ready(function () {
    var sync1 = $("#sync1");
    var sync2 = $("#sync2");
...
inputNumber($(".pro-quantily")); //tab chi tiết sản phẩm
